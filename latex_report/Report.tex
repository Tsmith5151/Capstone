...
\caption{Decision Boudary between binary classes for Logistic Regression (left) and Random Forest (right) with complex data structures (e.g. concave and convex}
\label{fig:boundary2}
\end{figure}
